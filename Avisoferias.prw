...
cQuery := "SELECT   RA_FILIAL ,RA_NOME,RA_MAT,CONVERT(CHAR(10),CAST(RT_DATABAS AS DATETIME),103) PER_AQ_DE,CONVERT(CHAR(10),CAST(RF_DATAFIM AS DATETIME),103) PER_AQ_ATE,CONVERT(CHAR(10),"
